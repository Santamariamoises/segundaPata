  ...
  render() {
    return (<div>
      <center>
        ...
        <SearchBar items={this.state.items} handleSubmitToys={this.handleSubmitToys} handleSubmitClothes={this.handleSubmitClothes} handleSubmitBeds={this.handleSubmitBeds} handleSubmitAccesories={this.handleSubmitAccesories}/>
